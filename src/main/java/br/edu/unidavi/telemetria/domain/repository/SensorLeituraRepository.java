 ...
 */
@RepositoryRestResource(collectionResourceRel = "sensoresleituras", itemResourceRel = "sensorleitura", path = "sensorleitura")
interface SensorLeituraRepository extends JpaRepository<SensorLeitura, Long> {
